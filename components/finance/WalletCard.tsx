...
const WALLET_META: Record<WalletType, { label: string; emoji: string; primary: string; secondary: string }> = {
  personal: {
    label: "Ví Cá Nhân",
    emoji: "👤",
    primary: "#818cf8",
...
export default function WalletCard({
  ...
  return (
    <div
      style={{
        background: `linear-gradient(135deg, ${meta.secondary} 0%, rgba(255,255,255,0.03) 100%)`,
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <div
            style={{
              ...
              border: `1px solid ${meta.primary}40`,
              display: "flex",
              alignItems: "center",
        ...
        <div style={{ textAlign: "right" }}>
          <div
            style={{
              fontSize: 20,
              fontWeight: 800,
              color: balance >= 0 ? meta.primary : "#ef4444",
              letterSpacing: "-0.5px",
            }}
          >
            {balance < 0 ? "-" : ""}{fmtVND(Math.abs(balance))}
          </div>
          <div style={{ fontSize: 9, color: "rgba(255,255,255,0.3)" }}>Số dư hiện tại</div>
        </div>
      </div>
      ...
      >
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <div>
            <div style={{ fontSize: 10, color: "rgba(255,255,255,0.35)" }}>Thu</div>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 6, paddingLeft: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 10, color: "rgba(255,255,255,0.35)" }}>Chi</div>
